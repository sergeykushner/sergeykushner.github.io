...
1. Оригинальный файл с приватными данными находится в `apps.json` в корне проекта.
2. Публичная версия (без приватных ключей) находится в `apps-public.json` в корне проекта.
